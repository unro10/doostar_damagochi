...
function checkAttendance() {
  ...
  hamster.attendStreak = (lastDate === yesterday)
...
function showAttendPopup(reward) {
  ...
  for (let i = 1; i <= 7; i++) {
    ...
    if (i < hamster.attendStreak)       cell.classList.add("done");
    else if (i === hamster.attendStreak) cell.classList.add("today");
...
// achievement.js, minigame.js 로드 후 실행되도록 window.onload 사용
